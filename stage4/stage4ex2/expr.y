...
varList:
    | varList ',' '*' ID
    {
        Install($4->varname,currentType,1,0,0,1);
    }
    | varList ',' ID '[' NUM ']'
    {
        if($5->val<=0){
        ...
        Install($3->varname,currentType,$5->val,1,0,0);
    }
    | varList ',' ID 
    {
        Install($3->varname, currentType, 1, 0,0,0);
    }
    | ID '[' NUM ']' '[' NUM ']'
    {
        if($3->val<=0 || $6->val<=0){
        ...
        Install($1->varname,currentType,$3->val*$6->val,1,$6->val,0);
    }
    | ID '[' NUM ']'
    {
        if($3->val<=0){
        ...
        Install($1->varname, currentType, $3->val, 1,0,0);
    }
    | '*' ID
    {
        Install($2->varname,currentType,1,0,0,1);
    }
    | ID 
    {
        Install($1->varname, currentType,1,0,0,0);
    }
