...
%type <node> Program Slist Stmt Expr Array
%type <type> type
...
varList:
    varList ',' ID '[' NUM ']'
    {
        ...
        Install($3->varname,currentType,$5->val,1);
    }
    | varList ',' ID 
    {
        Install($3->varname, currentType, 1, 0);
    }
    | ID '[' NUM ']'
    {
        if($3->val<=0){
        ...
        Install($1->varname, currentType, $3->val, 1);
    }
    | ID 
    {
        Install($1->varname, currentType,1,0);
    }
;
